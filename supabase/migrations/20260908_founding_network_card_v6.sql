-- Founding network card v6 (8 Sep 2026): the card carries no About text.
-- The reader exposes only what the card renders; app_profile.bio itself is
-- untouched (experience pages and the workspace profile editor use it).
