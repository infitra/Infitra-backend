...
export default async function ChallengeTribePage({
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Dark overlay — 88% opacity, waves hinted subtly */}
      <div
        className="fixed inset-0 z-[1] pointer-events-none"
        style={{ backgroundColor: "rgba(15, 34, 41, 0.88)" }}
      />
      ...
      <div className="relative z-[2]">
        ...
        <div className="flex-1 pt-20 px-6">
          <div className="max-w-3xl mx-auto py-10">
            ...
            <Link
              href={backPath}
              className="text-xs transition-colors mb-8 flex items-center gap-1.5 font-headline text-[#9CF0FF]/40 hover:text-white"
            >
              <svg
                width="14"
                height="14"
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-3">
                <span
                  ...
                  style={{
                    color: "#FF6130",
                    backgroundColor: "rgba(255, 97, 48, 0.15)",
              ...
              <h1 className="text-3xl md:text-4xl font-black font-headline tracking-tight mb-3 text-white">
                {space.title}
              </h1>
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <span className="text-xs font-black font-headline text-[#FF6130]">
                ...
                <div>
                  ...
                  {challengeTitle && (
                    <Link
                      ...
                      className="text-[10px] font-headline text-[#FF6130] hover:opacity-80"
                    >
                      {challengeTitle} &rarr;
                    </Link>
                  )}
              ...
              {space.description && (
                <p className="text-sm mt-4 max-w-lg text-[#9CF0FF]/50">
                  {space.description}
                </p>
              )}
            </div>
            ...
            {challengeSessions.length > 0 && (
              <div className="mb-6">
                <h3 className="text-xs font-bold uppercase tracking-wider font-headline mb-3 text-[#9CF0FF]/40">
                  Sessions
                </h3>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="text-sm font-bold font-headline truncate text-white">
                            {sess.title}
                          </p>
