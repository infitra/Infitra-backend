        ...
        {done !== null ? (
          <>
            ...
            <p className="text-sm leading-relaxed mb-6" style={{ color: "#475569" }}>
              ...
              time and your message right now, and your words are posted in the
              Tribe with the session attached. The schedule is already updated,
              and the live room will be ready at the new time.
            </p>
            <button
              onClick={onClose}
          ...
          <>
            ...
            <p className="text-sm leading-relaxed mb-5" style={{ color: "#475569" }}>
              Life happens: you&apos;re ill, something comes up at home, the day
              falls apart. When there&apos;s no other way, move the session and
              tell your tribe in your own words. They get the new time and your
              message right away, by email and as a post in your Tribe.
            </p>
            ...
            <label className="block mb-5">
              ...
              <textarea
                ...
                rows={2}
                maxLength={300}
                placeholder="e.g. I woke up with a fever and can't host tonight. Rest up, and see you at the new time!"
                className="mt-1.5 w-full px-3 py-2.5 rounded-xl text-sm resize-none"
                style={{ border: "1px solid rgba(15,34,41,0.15)", color: "#0F2229" }}
              />
              {!reasonOk && reason.length > 0 && (
                <span className="block mt-1 text-[11px]" style={{ color: "#94a3b8" }}>
                  A short sentence helps your tribe understand.
                </span>
              )}
            </label>
