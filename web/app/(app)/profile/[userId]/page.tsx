            ...
            <div className="mb-8">
              ...
              <div className="space-y-2">
                {(attendedSessions ?? []).map((a: any) => {
                  ...
                  return (
                    <div key={a.session_id} className="flex items-center gap-3 p-3 rounded-xl bg-[#0F2229] border border-[#9CF0FF]/10">
                ...
                {(challengeMemberships ?? []).map((m: any) => {
                  ...
                  return (
                    <Link
                      ...
                      className="flex items-center gap-3 p-3 rounded-xl bg-[#0F2229] border border-[#9CF0FF]/10 hover:border-[#FF6130]/20 transition-colors"
                    >
