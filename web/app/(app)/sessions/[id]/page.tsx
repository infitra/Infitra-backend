          ...
          <div className="rounded-2xl bg-[#0F2229] border border-[#9CF0FF]/10 overflow-hidden">
            ...
            <div className="p-8 md:p-10">
              ...
              {isHost ? (
                ...
                <button
                  disabled
                  className="w-full py-4 rounded-full bg-[#FF6130] text-white text-sm font-black font-headline shadow-[0_0_25px_rgba(255,97,48,0.3)] disabled:opacity-70"
                >
                  {isFree ? "Join Session" : `Get Ticket — CHF ${priceCHF.toFixed(2)}`}
                </button>
              )}
