...
export function DepthBackground() {
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden" aria-hidden="true">
      ...
      {/* ── SVG Wave Layers ──────────────────────────────── */}
      {/* Background wave — slowest, most blurred, lowest opacity */}
      <svg
        className="absolute bottom-0 left-0 w-[200%] h-[45%] opacity-[0.08] animate-[wave-drift_35s_ease-in-out_infinite]"
      ...
      >
        ...
        <defs>
          <linearGradient id="wave-bg" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="50%" stopColor="#4AB8CC" stopOpacity="0.3" />
            <stop offset="100%" stopColor="#FF6130" stopOpacity="0.4" />
          </linearGradient>
        </defs>
      </svg>

      {/* Middle wave — moderate speed, light blur */}
      <svg
        className="absolute bottom-0 left-0 w-[200%] h-[35%] opacity-[0.12] animate-[wave-drift_25s_ease-in-out_infinite_reverse]"
      ...
      >
        ...
        <defs>
          <linearGradient id="wave-mid" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="60%" stopColor="#0F2229" stopOpacity="0.4" />
            <stop offset="100%" stopColor="#FF6130" stopOpacity="0.3" />
          </linearGradient>
        </defs>
      </svg>

      {/* Foreground wave — fastest, subtle blur, highest opacity */}
      <svg
        className="absolute bottom-0 left-0 w-[200%] h-[25%] opacity-[0.15] animate-[wave-drift_18s_ease-in-out_infinite]"
      ...
      >
        ...
        <defs>
          <linearGradient id="wave-fg" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="70%" stopColor="#FF6130" stopOpacity="0.15" />
