...
/**
 * DepthBackgroundWaves — alternate background design (kept for /design-lab).
 *
 * Three layered SVG waves drift left/right at different speeds at the
 * bottom of the viewport, with 30 deterministic floating star particles
 * scattered above. This was the original DepthBackground before the
 * bottom-beam direction was chosen — preserved here so we can compare
 * design directions side by side in the lab.
 *
 * Animations live in globals.css under the "DepthBackgroundWaves
 * animations" section: wave-lr, wave-rl, particle-float.
 */
export function DepthBackgroundWaves() {
  const particles = [
    ...
    >
      ...
      >
        <svg viewBox="0 0 2880 280" preserveAspectRatio="none" className="w-full h-full">
          <defs>
            <linearGradient id="dlw-w1" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <path d="M0,140 Q360,60 720,120 Q1080,180 1440,80 Q1800,20 2160,120 Q2520,200 2880,100 L2880,280 L0,280 Z" fill="url(#dlw-w1)" />
        </svg>
      </div>
      ...
      >
        <svg viewBox="0 0 2880 200" preserveAspectRatio="none" className="w-full h-full">
          <defs>
            <linearGradient id="dlw-w2" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <path d="M0,90 Q360,150 720,80 Q1080,30 1440,100 Q1800,160 2160,70 Q2520,20 2880,90 L2880,200 L0,200 Z" fill="url(#dlw-w2)" />
        </svg>
      </div>
      ...
      >
        <svg viewBox="0 0 2880 120" preserveAspectRatio="none" className="w-full h-full">
          <defs>
            <linearGradient id="dlw-w3" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <path d="M0,60 Q360,100 720,50 Q1080,10 1440,65 Q1800,110 2160,40 Q2520,0 2880,55 L2880,120 L0,120 Z" fill="url(#dlw-w3)" />
        </svg>
      </div>
