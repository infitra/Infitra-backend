...
// Light-theme background where the wave shapes are drawn natively as
// diagonal wavy stripes (NOT horizontal waves rotated). Three layered
// stripes bend from lower-left toward upper-right, filled with the brand
// gradient. Fully static — no animation.
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden" aria-hidden="true">
        <svg viewBox="0 0 1600 1000" preserveAspectRatio="none" className="absolute inset-0 w-full h-full">
          <defs>
            ...
            <linearGradient id="wb-flow-2" x1="0%" y1="100%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#9CF0FF" stopOpacity="0.92" />
              <stop offset="35%" stopColor="#9CF0FF" stopOpacity="0.62" />
              <stop offset="50%" stopColor="#FFFFFF" stopOpacity="0.40" />
              <stop offset="65%" stopColor="#FF6130" stopOpacity="0.62" />
            ...
            <linearGradient id="wb-flow-3" x1="0%" y1="100%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#9CF0FF" stopOpacity="1" />
              <stop offset="50%" stopColor="#FFFFFF" stopOpacity="0.75" />
              <stop offset="100%" stopColor="#FF6130" stopOpacity="1" />
            </linearGradient>
            <filter id="wb-blur" x="-20%" y="-20%" width="140%" height="140%">
        ...
        <div className="flex items-center justify-between mt-12 mb-10">
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: "#64748b" }}>
              Diagonal bending waves preview · sample data
            </p>
          </div>
          <button
            type="button"
