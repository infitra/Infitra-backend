...
// TEMP PREVIEW — light-theme background with NATIVE diagonal wavy stripes.
//
// Each wave is an SVG path drawn directly as a wavy diagonal stripe
// (bending from bottom-left to top-right) — NOT a horizontal wave that's
// been rotated. Three stacked stripes drift slowly along the diagonal
// axis in opposite directions, creating a coherent flowing motion.
...
export default function TestWaveLightPage() {
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: "#F2EFE8" }}>
      {/* ═══════════════════════════════════════════════════════════
          BACKGROUND — diagonal wavy stripes drawn natively
          Each stripe is a closed SVG path with two parallel-ish wavy
          lines connecting bottom-left and top-right of the viewBox.
          The fill is a brand gradient aligned with the diagonal.
          Three stripes (back / mid / front) of decreasing thickness,
          each drifting slowly along the diagonal axis.
          ═══════════════════════════════════════════════════════════ */}
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden" aria-hidden="true">
        {/*
          Identical visual setup to /design-lab/wave-bending — same
          colours, same gradient stops, same path data, same gradient
          direction. NO spatial transform (corners stay anchored) and
          NO colour filter (brand colours stay exact). Motion comes
          purely from a small opacity pulse on each wave, with Wave 1
          and Wave 2 in opposite phase so the layers alternate.
        */}

        {/* Wave 1 — back, biggest, heavily blurred. */}
        <div
        ...
        >
          <svg viewBox="0 0 1600 1000" preserveAspectRatio="none" className="absolute inset-0 w-full h-full">
            <defs>
              <linearGradient id="dws-flow-1" x1="0%" y1="100%" x2="100%" y2="0%">
              ...
              <filter id="dws-blur" x="-20%" y="-20%" width="140%" height="140%">
        ...
        {/* Wave 2 — middle layer, fastest dim/peak. */}
        <div
          className="absolute inset-0"
          style={{
        ...
        >
          <svg viewBox="0 0 1600 1000" preserveAspectRatio="none" className="absolute inset-0 w-full h-full">
            <defs>
              <linearGradient id="dws-flow-2" x1="0%" y1="100%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#9CF0FF" stopOpacity="0.92" />
                <stop offset="35%" stopColor="#9CF0FF" stopOpacity="0.62" />
                <stop offset="50%" stopColor="#FFFFFF" stopOpacity="0.40" />
                <stop offset="65%" stopColor="#FF6130" stopOpacity="0.62" />
        ...
        >
          <svg viewBox="0 0 1600 1000" preserveAspectRatio="none" className="absolute inset-0 w-full h-full">
            <defs>
              <linearGradient id="dws-flow-3" x1="0%" y1="100%" x2="100%" y2="0%">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-10">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span
              className="text-lg font-black tracking-tighter font-headline italic"
              style={{ color: "#FF6130" }}
            >
              INFITRA
            </span>
